...
import Bloc_Acum_epy_block_0 as epy_block_0  # embedded python block
import sip



class Bloc_Acum(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Bloc_Acum")
...
def main(top_block_cls=Bloc_Acum, options=None):
