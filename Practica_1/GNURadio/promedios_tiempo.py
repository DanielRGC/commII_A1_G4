...
import promedios_tiempo_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class promedios_tiempo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "promedios_tiempo")
        ...
        self.qtgui_number_sink_0_1_0_0 = qtgui.number_sink(
            gr.sizeof_float,
            0,
        ...
        self.qtgui_number_sink_0_1_0_0.set_update_time(0.10)
        self.qtgui_number_sink_0_1_0_0.set_title("Desviacion Estandar")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_1_0_0.set_min(i, -1)
            self.qtgui_number_sink_0_1_0_0.set_max(i, 1)
            self.qtgui_number_sink_0_1_0_0.set_color(i, colors[i][0], colors[i][1])
            if len(labels[i]) == 0:
                self.qtgui_number_sink_0_1_0_0.set_label(i, "Data {0}".format(i))
            else:
                self.qtgui_number_sink_0_1_0_0.set_label(i, labels[i])
            self.qtgui_number_sink_0_1_0_0.set_unit(i, units[i])
            self.qtgui_number_sink_0_1_0_0.set_factor(i, factor[i])

        self.qtgui_number_sink_0_1_0_0.enable_autoscale(False)
        self._qtgui_number_sink_0_1_0_0_win = sip.wrapinstance(self.qtgui_number_sink_0_1_0_0.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_number_sink_0_1_0_0_win)
        ...
        self.qtgui_number_sink_0_1_0.set_title("Potencia Promedio")
        ...
        self.qtgui_number_sink_0_0_0.set_title("Media")
        ...
        self.qtgui_number_sink_0_0.set_title("Media_Cuadratica")
        ...
        self.connect((self.epy_block_0, 0), (self.qtgui_number_sink_0_0_0, 0))
        self.connect((self.epy_block_0, 2), (self.qtgui_number_sink_0_1, 0))
        self.connect((self.epy_block_0, 3), (self.qtgui_number_sink_0_1_0, 0))
        self.connect((self.epy_block_0, 4), (self.qtgui_number_sink_0_1_0_0, 0))
...
def main(top_block_cls=promedios_tiempo, options=None):
