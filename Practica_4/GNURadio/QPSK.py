...
class QPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.Tabla_de_verdad_Constelacion = Tabla_de_verdad_Constelacion = (1, 0+1j, -1,0-1j)
        ...
        self.qtgui_vector_sink_f_0.set_y_axis((-140), 15)
        ...
        self.blocks_vector_to_stream_1 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 1024)
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_float*1, 1024)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, 1024)
        self.blocks_packed_to_unpacked_xx_0 = blocks.packed_to_unpacked_bb(Nbps, gr.GR_MSB_FIRST)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_stream_to_vector_1, 0))
