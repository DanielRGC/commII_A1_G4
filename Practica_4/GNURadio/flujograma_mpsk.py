...
import flujograma_mpsk_epy_block_0 as epy_block_0  # embedded python block
import math
import sip
import threading
...
class flujograma_mpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "flujograma_mpsk")
        ...
        self.qtgui_vector_sink_f_0.set_y_axis((-10), 12000)
...
def main(top_block_cls=flujograma_mpsk, options=None):
